...
const Producers: FC = () => {
  useSEO({
    ...
    description: 'Conoce a las más de 200 familias cacaoteras de Zamora Chinchipe responsables de nuestro cacao fino de aroma.',
    keywords: 'productores cacao Ecuador, familias cacaoteras, Zamora Chinchipe agricultores, ASOPROMAS',
    url: '/about/producers',
  });

  const stats = [
    { icon: <Users />, num: '200', label: 'Familias Productoras' },
    { icon: <MapPin />, num: '13', label: 'Comunidades' },
    { icon: <TrendingUp />, num: '51%', label: 'Liderazgo Femenino' },
    { icon: <Home />, num: '84+', label: 'Hectáreas de Cacao' }
  ];
    ...
    <div className="min-h-screen bg-stone-50 font-sans text-stone-800">
      <section className="relative pt-40 pb-20 px-6 bg-cacao-green-950 text-center overflow-hidden">
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-xl text-cacao-green-100/90 font-light leading-relaxed max-w-2xl mx-auto">200 familias ecuatorianas unidas por la pasión, la tierra y el legado del mejor cacao del mundo.</p>
        </motion.div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }}>
            ...
            <p className="text-lg text-cacao-green-800/80 font-light leading-relaxed mb-6">
              Nuestra asociación empodera directamente a sus socios mediante precios justos y capacitación constante. Estamos orgullosos de que el 51% de nuestra directiva y bases esté conformado por mujeres rurales, jefas de familia y guardianas de la sabiduría ancestral.
            </p>
            <p className="text-lg text-cacao-green-800/80 font-light leading-relaxed">
              Mediante escuelas de campo y certificaciones internacionales, logramos un incremento promedio del 15% en los ingresos familiares, mejorando la calidad de vida a comunidades en Zamora Chinchipe y Morona Santiago.
            </p>
          </motion.div>

...
const ProductComponent: FC = () => {
  ...
  useSEO({
    title: 'Barra de Chocolate con Café | ASOPROMAS',
    description: 'Barra de Chocolate Fino Artesanal al 65% con Café. La combinación perfecta.',
    keywords: 'chocolate y cafe',
    url: '/products/chocolate-coffee',
  });

  const features = [
    { icon: <Award />, title: "65% Cacao", desc: "Porcentaje ideal para permitir que las notas del café destaquen sin abrumar." },
    { icon: <Leaf />, title: "Café Tostado Local", desc: "Granos de café de especialidad de la misma región amazónica." },
    { icon: <Star />, title: "Textura Crocante", desc: "Inclusiones de café que aportan un crujido estimulante en cada mordisco." },
    { icon: <Heart />, title: "Artesanal", desc: "Temperado a mano para asegurar el brillo perfecto y el sonido 'snap'." }
  ];
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-white">
        ...
        >
          ...
          <h1 className="text-6xl sm:text-8xl md:text-9xl font-light text-chocolate-950 mb-8 leading-none tracking-tight">
            Barra de Chocolate con <br />
            <span className="font-medium font-serif text-chocolate-800 tracking-wide">Café</span>
          </h1>
          <p className="text-xl sm:text-2xl text-stone-500 font-light max-w-2xl mx-auto">
            La combinación perfecta entre chocolate premium y café tostado.
          </p>
        </motion.div>
      </section>
            ...
            <div className="lg:w-1/2 py-10 lg:py-[30vh]">
              <div className="space-y-32">
                <motion.div
                  ...
                  className="space-y-6"
                >
                  <h2 className="text-4xl font-light text-white mb-6">Dos Pasiones en un <span className="font-serif text-amber-200 tracking-wide">Bocado</span></h2>
                  <p className="text-xl text-stone-400 font-light leading-relaxed">
                    Hemos fusionado dos de los tesoros más grandes del Ecuador. El sabor profundo de nuestro cacao se entrelaza mágicamente con las notas tostadas del café de altura.
                  </p>
                </motion.div>
      ...
      <section className="py-32 bg-white px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-stone-50 p-8 sm:p-12 rounded-[2rem] border border-stone-100 shadow-xl">
            <ContactForm productName="Barra de Chocolate con Café" />
          </div>
        </div>
      </section>

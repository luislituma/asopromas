...
const PureChocolateBar: FC = () => {
  ...
  useSEO({
    title: 'Barra de Chocolate al 100% | ASOPROMAS',
    description: 'Barra de cacao pura al 100%. Cacao de fino aroma sin azúcar.',
    keywords: 'barra de cacao 100%, cacao para taza, chocolate puro Ecuador, cacao sin azúcar',
  ...
  return (
    <div className="min-h-screen bg-stone-50 font-sans text-stone-800">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 overflow-hidden bg-white">
        ...
        >
          <p className="text-chocolate-400 font-medium tracking-[0.3em] uppercase text-xs mb-8">CHOCOLATES</p>
          <h1 className="text-6xl sm:text-8xl md:text-9xl font-light text-chocolate-950 mb-8 leading-none tracking-tight">
            ...
            <span className="font-medium font-serif italic text-chocolate-800">100%</span>
          </h1>
          <p className="text-xl sm:text-2xl text-stone-500 font-light max-w-2xl mx-auto">
            La expresión definitiva del cacao amazónico.
          </p>
        </motion.div>
      </section>
      ...
      <section className="py-32 bg-white px-6">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-light text-chocolate-900 mb-6">Adquiere <span className="font-serif italic text-chocolate-800">Chocolate al 100%</span></h2>

...
import { Map, Leaf, Coffee, Sun, Compass, Camera, CalendarHeart } from 'lucide-react';
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center mt-20">
          ...
          >
            <motion.div variants={fadeInUp} className="inline-flex items-center gap-3 px-5 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-8">
              ...
              <span className="text-cacao-green-50 font-medium tracking-[0.2em] uppercase text-sm">Turismo Vivencial</span>
            </motion.div>
            ...
            <motion.p variants={fadeInUp} className="text-xl sm:text-2xl text-cacao-green-100/90 font-light max-w-3xl mx-auto leading-relaxed">
              Sumérgete en una experiencia donde el aroma a tierra húmeda, la historia milenaria y la naturaleza convergen en un solo viaje.
            </motion.p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            ...
            >
              ...
              <motion.div variants={fadeInUp} className="space-y-6 text-lg text-stone-600 font-light leading-relaxed">
                <p>
                  Nuestra ruta no es solo un paseo, es un retorno a las raíces. Te llevaremos al corazón mismo de las fincas de <strong className="text-cacao-green-900 font-medium">ASOPROMAS</strong> en la Amazonía ecuatoriana.
                </p>
                <p>
                  Caminarás bajo la sombra de árboles centenarios, tocando la tierra que da vida al cacao fino de aroma. Aprenderás de las manos de nuestros productores el delicado arte de la cosecha, el secreto de una fermentación perfecta y la paciencia del secado al sol.
                </p>
              </motion.div>
            </motion.div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-stone-500 font-light max-w-2xl mx-auto">
              Diseñamos cada etapa de este viaje para que te conectes profundamente con la cultura del cacao.
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Map, title: "Paseo por las Fincas", desc: "Caminata guiada por los senderos de los bosques comestibles." },
              { icon: Leaf, title: "Cosecha Participativa", desc: "Aprende a identificar y recolectar las mazorcas en su punto ideal." },
              { icon: Sun, title: "Magia Post-cosecha", desc: "Observa los procesos artesanales de fermentación y secado." },
              { icon: Coffee, title: "Cata Profesional", desc: "Degustación guiada de chocolates puros y licores premium." }
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30 }}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            >
              ...
              <p className="text-lg text-stone-400 font-light leading-relaxed">
                Nuestros grupos son reducidos para garantizar una experiencia íntima, personalizada y respetuosa con el entorno. Completa el formulario para coordinar las fechas disponibles y los detalles de tu expedición.
              </p>
